...
namespace KnockoutHelpers.Attributes
{
    /// <summary>
    ...
    public class PrecisionAttribute : Attribute
    {
        ...
        //{
        //    modelBuilder.Properties().Where(x => x.GetCustomAttributes(false).OfType<PrecisionAttribute>().Any())
        //        .Configure(c => c.HasPrecision(c.ClrPropertyInfo.GetCustomAttributes(false).OfType<PrecisionAttribute>().First().Precision, c.ClrPropertyInfo.GetCustomAttributes(false).OfType<PrecisionAttribute>().First().Scale));
        //}
    }
}
