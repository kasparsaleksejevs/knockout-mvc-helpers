...
namespace KnockMvc.Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult MvcHelperGrid()
        {
            ...
            {
                new MyRow { IntValue = 3, BoolValue = true, DateValue = DateTime.Now, DecimalValue = 12.34m, DoubleValue = 0.234522, EnumValue = MyEnum.Val1, StringValue = "test" },
                ...
                new MyRow { IntValue = 42, BoolValue = true, DateValue = DateTime.Now.AddYears(1).ToUniversalTime(), DecimalValue = 20.445m, DoubleValue = 0.21, EnumValue = MyEnum.Val1, StringValue = "zzzzz" },
                new MyRow { IntValue = 11, BoolValue = true, DateValue = DateTime.Now.ToUniversalTime(), DecimalValue = 20.444m, DoubleValue = 0.3562, EnumValue = MyEnum.Val2, StringValue = "ttttt" },
